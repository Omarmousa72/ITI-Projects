...
function getFBNewsFeed() {
    return __awaiter(this, void 0, void 0, function () {
        var repsonse, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://www.facebook.com/feeds/")];
                case 1:
                    repsonse = _a.sent();
                    return [4 /*yield*/, repsonse.json()];
                case 2:
                    data = _a.sent();
                    console.log("Successfully loaded ".concat(data));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.log("News Feed Didn't Load Error Occurred ".concat(error_1));
                    return [3 /*break*/, 4];
...
getYoutubeVideo("https://www.youtube.com/watch?v=1").then(function (video) {
    console.log("Success ".concat(video));
})
